...
- [SeisKit.jl](https://github.com/JuliaEarth/SeisKit.jl) – ![Julia](media/icon/julia.png) Fast IO operations with SEG-Y files and other basic utilities for working with seismic data.
